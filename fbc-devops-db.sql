...
CREATE TABLE if not exists `device_config` (
  ...
  `parent_spec` varchar(4096) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT '父設備SPEC',
  ...
  `nvme_desc` varchar(4096) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT '設備的Nvme描述',
  `gpu_count` int(8) NULL DEFAULT NULL COMMENT '設備的Gpu數量',
  `gpu_desc` varchar(4096) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT '設備的Gpu描述',
  `memory_size` bigint(64) NULL DEFAULT NULL COMMENT '設備的內存總大小',
  `memory_count` int(8) NULL DEFAULT NULL COMMENT '設備的內存條數',
  `memory_desc` varchar(4096) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT '設備的內存描述',
  `cpu_count` int(8) NULL DEFAULT NULL COMMENT '設備的Cpu數量',
  `cpu_desc` varchar(4096) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT '設備的Cpu描述',
  `hdd_count` int(8) NULL DEFAULT NULL COMMENT '設備的Hdd數量',
  `hdd_desc` varchar(4096) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT '設備的Hdd描述',
  `ethernet_count` int(8) NULL DEFAULT NULL COMMENT '設備的網卡數量',
  `ethernet_desc` varchar(4096) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL COMMENT '設備的網卡描述',
...
REPLACE INTO device_role (id, role_name) VALUES(6, 'gateway');
